...
router.route('/check/password').get(checkLogin, account.checkPassword);
router.route('/check/password_submit').post(checkLogin, account.postPassword);
router.route('/account/management').get(checkLogin, account.loadAccount);
router.route('/account/tel_submit').post(checkLogin, account.postChangeTel);
router.route('/account/password_submit').post(checkLogin, account.postChangePw);
